...
namespace JenianAPI.Services
{
  public class OpenAiService
  {
    ...
    //}
    private static string ExtractAfterLastToday(string ocrText) {
...
{
  private static readonly Regex DeliveryLineRegex =
...
//  Before applying any extraction rules, you MUST follow the Rules bellow.
